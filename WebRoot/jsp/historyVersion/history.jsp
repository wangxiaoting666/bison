...
<%@include file="../includes/sidebar.jsp"%>
    <div class="page-content-wrapper">
        <div class="page-content" id="user-margin">
                    ...
                    <div class="portlet">
                        ...
                        <div class="portlet-body">
                            <div class="table-container">
                                    <div>
                                        <div><span>version:</span><span>&nbsp;v 1.0.0</span></div>
                                        <div><span>upper:</span><span>&nbsp;lzg</span></div>
                                        <div><span>point:</span><span>&nbsp;the first version that need to test</span></div>
                                        <div><span>date:</span><span>&nbsp;2016.1.2</span></div>
                                        <br/>
                                    </div>
                        </div>
                    </div>
