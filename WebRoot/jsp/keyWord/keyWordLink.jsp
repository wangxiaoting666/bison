                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="javascript:;" class="btn default yellow-stripe" id="addKeyWordLink">
                                    <i class="fa fa-refresh"></i><span class="hidden-480"> 新增关键字链接</span></a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="hidden" id="keyWordLinkId">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-4 control-label">链接字段<span class="required"> * </span></label>

                                    <div class="col-md-8">
                                        <input type="text" class="form-control input-medium" placeholder="链接字段"
                                               id="keyWordLink" name="keyWordLink">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
...
<script src="<c:url value="/js/keyWord/keyWordLink.js"/>"></script>
<script type="text/javascript">
    $(function () {
        keyWordLinkListTable.init();
    });
</script>
</body>
</html>