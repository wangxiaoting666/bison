                ...
                <div class="col-md-12">
                    <div class="portlet">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="javascript:;" class="btn default yellow-stripe" id="addKeyWordShield">
                                    <i class="fa fa-refresh"></i><span class="hidden-480"> 新增关键字屏蔽</span></a>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-4 control-label">关键字名称<span class="required"> * </span></label>

                                    <div class="col-md-8">
                                        <input type="hidden" id="keyWordShieldId">
                                        <input type="text" class="form-control input-medium" placeholder="关键字名称"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-4 control-label">替换字段<span class="required"> * </span></label>

                                    <div class="col-md-8">
                                        <input type="text" class="form-control input-medium" placeholder="替换字段"
                                               id="replaceWord" name="replaceWord">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
...
<script src="<c:url value="/js/keyWord/keyWordShield.js"/>"></script>
<script type="text/javascript">
    $(function () {
        keyWordShieldListTable.init();
    });
</script>
</body>
</html>