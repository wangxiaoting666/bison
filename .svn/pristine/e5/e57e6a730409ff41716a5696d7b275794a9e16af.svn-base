                            ...
                            <div class="table-container">
                                <table class="table table-striped table-bordered table-hover" id="dataTable">
                                    ...
                                    <tr role="row" class="filter">
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="singlePageNameQuery" id="singlePageNameQuery">
                                        </td>
                                        <td>
...
<script type="text/javascript" src="<c:url value="/js/global/plugins/ckeditor/ckeditor.js"/>"></script>
<script src="<c:url value="/js/global/scripts/datatable.js"/>"></script>
<script src="<c:url value="/js/news/singlePageContent.js"/>"></script>
<script type="text/javascript">
    $(function(){
        singlePageContentListTable.init();
    });
</script>
</body>
</html>