...
<div id="content">
    ...
    <div id="details">
        <div class="left"><!--左侧菜单栏-->
            ...
            <#--todo 确定url地址-->
                <li><a href="index.do?act=list&module=anli&t=${newsType.newsTypeId}">${newsType.newsTypeName}</a>
                </li>
            </#list>
            </ul>
        </div>
            ...
            <#list pageList as news>
                <div class="system">
                    <div class="recognition"
                        ...
                        <a href="index.do?act=detail&module=anli&detail=${news.newsId}" title="${news.title}">
                            <p>
                ...
                <div class="pagination">
                    ...
                    <span class="center">
                        ...
                        <a href="#">
                            <li class="li_04">总计${totalResult}条</li>
                        </a>
                        <a href="#">
                            <li class="li_04">共${totalPage}页</li>
                        </a>
                    </span>
                    </ul>
                </div>
