var firmwareTable = function () {
    ...
    var url = {
        list: basePath + pagePath + "getFirmwareListPage",
    ...
    var uploadShow = function () {
        $(".modal-title", $uploadWin).html("上传固件");
        customGlobal.clearFormAndShowDialog("uploadWin");
    ...
    var editShow = function () {
        $(".modal-title", $editWin).html("编辑固件包");
