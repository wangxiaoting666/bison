                        ...
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="javascript:;" class="btn default yellow-stripe" id="uploadShow">
                                    <i class="fa fa-plus"></i><span class="hidden-480">上传应用</span></a>
                ...
                <form class="form form-horizontal">
                    <div class="form-body">
                        <div class="form-group">
                            <label class="col-md-4 control-label">应用版本<span class="required"> * </span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control input-medium"
                                       placeholder="请输入应用版本" name="version">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">应用描述&nbsp;&nbsp;&nbsp;</label>
                            <div class="col-md-8">
                                <textarea class="form-control" rows="8" wrap="hard"
                                          placeholder="请输入对本应用版本的描述" name="description"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-footer">
                        <div class="form-group">
                            <label class="col-md-4 control-label">应用文件<span class="required"> * </span></label>
                            <div class="col-md-8">
                                <input type="file" class="file-loading" name="applicationFile">
                            </div>
                        </div>
                    </div>
                </form>
...
<script type="text/javascript" src="<c:url value="/js/devicemanage/application.js"/>"></script>
<script type="text/javascript">
    $(function () {
