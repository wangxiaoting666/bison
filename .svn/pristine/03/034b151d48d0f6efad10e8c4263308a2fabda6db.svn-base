          ...
          <div class="form-body">
            <div class="row">
              <div class="col-md-12">
				...
				<input type="hidden" id="assetId" value="${param.personId}"/>
...
$(function(){
		...
		$.ajax({
			...
			var asset = data.returnData.user;
					
				$("#personId").val(user.personId);
				$("#personName").val(user.personName);
				$("#personSex").val(user.personSex);
				$("#organId").val(user.organId);
				$("#brithday").val(user.brithday);
				$("#phone").val(user.phone);
				$("#Address").val(asset.Address);
				$("#personLiable").val(user.personLiable);
